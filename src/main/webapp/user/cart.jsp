    ...
    <table>
        ...
        %>
            <tr>
                ...
                <td>
                    <form method="post" action="<%= request.getContextPath() %>/updateCartItem" style="display:inline;">
                        <input type="hidden" name="productId" value="<%= p.getProId() %>">
                        <input type="date" name="orderArrivedDay" value="<%= item.getOrderArrivedDay() != null ? item.getOrderArrivedDay().toString() : "" %>" required>
                </td>

                <td>¥<%= p.getProUnitNum() %></td>

                <td>
                        <input type="number" name="quantity" value="<%= item.getQuantity() %>" min="1" style="width: 60px;" required>
                ...
                <td>
                    <form method="post" action="<%= request.getContextPath() %>/deleteCartItem" style="display:inline;">
                        <input type="hidden" name="productId" value="<%= p.getProId() %>">
