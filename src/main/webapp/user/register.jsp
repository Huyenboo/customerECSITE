...
<body>
  <div class="register-box">
    ...
    <form action="<%= request.getContextPath() %>/register" method="post">
      ...
      <label for="president_phone_num">代表電話番号</label>
      <input type="text" id="president_phone_num" name="president_phone_num" required>

      <label for="manager_name">担当者氏名</label>
      <input type="text" id="manager_name" name="manager_name" required>

      <label for="manager_email">担当者メールアドレス</label>
      <input type="email" id="manager_email" name="manager_email" required>

      <label for="manager_phone_num">担当者電話番号</label>
      <input type="text" id="manager_phone_num" name="manager_phone_num" required>

      <label for="password">パスワード</label>
      <input type="password" id="password" name="password" required>

      <label for="confirm_password">パスワード再確認</label>
