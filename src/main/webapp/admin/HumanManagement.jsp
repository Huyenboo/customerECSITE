...
<!--    <a href="/HumanChangeServlet" class="button">編集</a>-->
    ...
    <table>
      <tr>
          <th>会社名</th><th>担当者名</th>
          <th>電話番号</th><th>メールアドレス</th
          ><th>住所</th><th>操作</th>
      ...
      <tr>
        ...
        <td>
          <a href="<%= request.getContextPath() %>/HumanEditServlet?id=<%= c.getId() %>">変更</a> |
          <a href="<%= request.getContextPath() %>/HumanDeleteServlet?id=<%= c.getId() %>"
